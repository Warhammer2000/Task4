...
public class UsersController : Controller
{
    ...
    public UsersController(UserManager<User> userManager, SignInManager<User> signInManager, UserService userService)
    {
...
//TODO Половина логики из UserController в UserService